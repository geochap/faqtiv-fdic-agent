...
def doTask(sort_by: str, limit: int):
    import json
    top_banks = get_top_n_banks(sort_by=sort_by, sort_order='desc', limit=limit)
    bank_ids = [bank['ID'] for bank in top_banks if 'ID' in bank]
